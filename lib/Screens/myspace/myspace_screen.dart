...
import 'package:hotstar/services/reusecode.dart';
        ...
        decoration: const BoxDecoration(
          ...
          children: [
            Row(
                         ...
                         const Row(
                          children: [
                             Profile(imageurl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQft76tKg6I5MYlC2liryTZFGrpVQIzSJUTqQ&usqp=CAU',name: 'Eva',),
                          SizedBox(width: 20,),
                           Profile(imageurl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWV6dKHmFirKFvNP5EfljnfcugjFmaY4ziMR8xBmDB6vuHeCCSMDOmC0_S5N1YkTfw9AM&usqp=CAU',name: 'Add',)
                          ],
                         )
          ]
        ),
