...
class  Latestrelease extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return   FutureBuilder(future: futurefunction, builder: (context,snapshot){
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: (){
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=> ViewScreen(index: index,valueNotifier: valueNotifier,)));
                    },
                  ),
                );
              },
