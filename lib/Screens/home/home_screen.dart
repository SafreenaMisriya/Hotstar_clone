      ...
      body:
         SingleChildScrollView(
           ...
           const  Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
                 Text('Latest Releases',style:TextStyle(fontWeight: FontWeight.w500,fontSize: 18),),
           ...
           const  Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
                 Text('Popular Shows',style:TextStyle(fontWeight: FontWeight.w500,fontSize: 18),),
                 Icon(Icons.keyboard_arrow_right_outlined)
               ],
             ),
               const SizedBox(
           ...
           const  Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
                 Text('Upcoming Movies',style:TextStyle(fontWeight: FontWeight.w500,fontSize: 18),),
                 Icon(Icons.keyboard_arrow_right_outlined),
               ],
             ),
               const SizedBox(
           ...
           const  Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
                 Text('Top Rated Movies',style:TextStyle(fontWeight: FontWeight.w500,fontSize: 18),),
                 Icon(Icons.keyboard_arrow_right_outlined),
               ],
             ),
               const SizedBox(
           ...
           const  Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
                 Text('Crime Movies',style:TextStyle(fontWeight: FontWeight.w500,fontSize: 18),),
                 Icon(Icons.keyboard_arrow_right_outlined),
               ],
             ),
               const SizedBox(
           ...
           const  Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
                 Text('Top Rated TV Shows',style:TextStyle(fontWeight: FontWeight.w500,fontSize: 18),),
                 Icon(Icons.keyboard_arrow_right_outlined),
               ],
             ),
               const SizedBox(
           ...
           const  Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
                 Text('Horror Movies',style:TextStyle(fontWeight: FontWeight.w500,fontSize: 18),),
                 Icon(Icons.keyboard_arrow_right_outlined)
               ],
             ),
               const SizedBox(
