  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(children: [
        ...
        Latestrelease(
          valueNotifier: latestrelease,
          futurefunction: loadlatest(),
        ),
        const SizedBox(
          height: 20,
        ),
        ...
        MovieScreen(
            futurefunction: loadlatestmovies(), valueNotifier: popularshows),
        const SizedBox(
          height: 20,
        ),
        const Row(
        ...
        MovieScreen(
            futurefunction: loadcrimemovies(), valueNotifier: crimemovie),
        const SizedBox(
          height: 20,
        ),
        const Row(
